...
INSERT INTO `Rental` (`id`, `picture`, `title`, `slug`, `visible_on_front`, `shortDescription`, `description`, `surface`, `emission_of_greenhouse`, `createdAt`, `updatedAt`)
VALUES
	(10000,458,'Appartement A','appartement-1',1,'Appartement 1 ed hendrerit efficitur ipsum, vitae egestas','Morbi condimentum mollis elit sit amet consectetur. Nulla faucibus ultricies ornare. Sed varius porttitor lacus, a iaculis erat convallis eget. Duis nec nisi tincidunt, consequat elit in, mattis quam. Nunc ultricies sem neque, sed placerat eros fringilla','60',465,'0000-00-00 00:00:00','0000-00-00 00:00:00'),
	(10001,457,'Appartement 2','appartement-2',1,'Ed hendrerit efficitur ipsum, vitae egestas mauris aliquet sagittis.','Morbi condimentum mollis elit sit amet consectetur. Nulla faucibus ultricies ornare. Sed varius porttitor lacus, a iaculis erat convallis eget. Duis nec nisi tincidunt, consequat elit in, mattis quam. Nunc ultricies sem neque, sed placerat eros fringilla','28',465,'0000-00-00 00:00:00','0000-00-00 00:00:00');

/*!40000 ALTER TABLE `Rental` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table vic_analytics_browse_event
# ------------------------------------------------------------
...
INSERT INTO `vic_analytics_browse_event` (`id`, `author_id`, `ip`, `viewReferenceId`, `referer`, `createdAt`, `updatedAt`)
VALUES
	(1,20,'127.0.0.1','ref_115','http://demo.victoire.dev/app_dev.php/login','2015-08-21 12:05:21','2015-08-21 12:05:21'),
	(2,20,'127.0.0.1','ref_115','http://demo.victoire.dev/app_dev.php/login','2015-08-21 12:05:58','2015-08-21 12:05:58'),
	(3,20,'127.0.0.1','ref_418','http://demo.victoire.dev/app_dev.php/','2015-08-21 12:07:55','2015-08-21 12:07:55'),
	(4,20,'127.0.0.1','ref_115','http://demo.victoire.dev/app_dev.php/logements','2015-08-21 12:08:12','2015-08-21 12:08:12'),
	(5,20,'127.0.0.1','ref_418','http://demo.victoire.dev/app_dev.php/','2015-08-21 12:08:20','2015-08-21 12:08:20'),
...
VALUES
	...
	(3,NULL,420,419,421,'Troisième article','troisieme-article','Lorem ipsum slkdfjlsdkjfsdlkhgjsdl kg','published',NULL,NULL,1,'0000-00-00 00:00:00','0000-00-00 00:00:00');

/*!40000 ALTER TABLE `vic_article` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table vic_article_tags
# ------------------------------------------------------------
...
# Dump of table vic_entity_proxy
# ------------------------------------------------------------
...
# Dump of table vic_media_folders
# ------------------------------------------------------------
...
# Dump of table vic_route_history
# ------------------------------------------------------------
...
CREATE TABLE `vic_view` (
  ...
  CONSTRAINT `FK_FAA91F341341DB46` FOREIGN KEY (`entityProxy_id`) REFERENCES `vic_entity_proxy` (`id`) ON DELETE CASCADE,
...
# Dump of table vic_widget_articlelist
# ------------------------------------------------------------
...
INSERT INTO `vic_widget_articlelist` (`id`, `global_link_title`, `global_link_url`, `global_link_label`, `title`)
VALUES
...
# Dump of table vic_widget_breadcrumb
# ------------------------------------------------------------
...
# Dump of table vic_widget_button
# ------------------------------------------------------------
...
# Dump of table vic_widget_ckeditor
# ------------------------------------------------------------
...
# Dump of table vic_widget_cover
# ------------------------------------------------------------
...
# Dump of table vic_widget_disqus
# ------------------------------------------------------------
...
# Dump of table vic_widget_filter
# ------------------------------------------------------------
...
CREATE TABLE `vic_widget_filter` (
  ...
  `defaultValue` varchar(55) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
# Dump of table vic_widget_image
# ------------------------------------------------------------
...
# Dump of table vic_widget_layout
# ------------------------------------------------------------
...
# Dump of table vic_widget_listing
# ------------------------------------------------------------
...
INSERT INTO `vic_widget_listing` (`id`, `targetPattern_id`, `maxResults`, `randomResults`)
VALUES
	(202,NULL,NULL,0),
	(213,415,NULL,0),
	(218,NULL,NULL,0);
...
# Dump of table vic_widget_listing_item
# ------------------------------------------------------------
...
# Dump of table vic_widget_markdown
# ------------------------------------------------------------
...
# Dump of table vic_widget_menu_item
# ------------------------------------------------------------
...
# Dump of table vic_widget_render
# ------------------------------------------------------------
...
# Dump of table vic_widget_sharethis
# ------------------------------------------------------------
...
# Dump of table vic_widget_simplecontactform
# ------------------------------------------------------------
...
# Dump of table vic_widget_simplecontactform_message
# ------------------------------------------------------------
...
# Dump of table vic_widget_sitemap
# ------------------------------------------------------------
...
# Dump of table vic_widget_slider
# ------------------------------------------------------------
...
# Dump of table vic_widget_slider_item
# ------------------------------------------------------------
...
# Dump of table vic_widget_tab_item
# ------------------------------------------------------------
...
# Dump of table vic_widget_title
# ------------------------------------------------------------
